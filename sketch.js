...
var shotgun, soldier, tank, bomber, ranger;
var shotgunimg, soldierimg, tankimg, bomberimg, rangerimg;
...
function setup(){
  ...
  shotgun = createSprite(400, 400, 200,200);
  shotgun.addImage(shotgunimg);
  shotgun.scale = 0.3;
  shotgun.visible = true;

  soldier = createSprite(400, 300, 200,200);
  soldier.addImage(soldierimg);
  soldier.scale = 0.3;
  soldier.visible = true;

  tank = createSprite(400, 500, 200,200);
  tank.addImage(tankimg);
  tank.scale = 0.3;
  tank.visible = true;

  ranger = createSprite(400, 600, 200,200);
  ranger.addImage(rangerimg);
  ranger.scale = 0.3;
  ranger.visible = true;

  bomber = createSprite(400, 700, 200,200);
  bomber.addImage(bomberimg);
  bomber.scale = 0.3;
  bomber.visible = true;

  picker = createSprite(250, 305, 200,200);
